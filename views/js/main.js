...
// moving var pizzasDiv out of loop
...
function updatePositions() {
  ...
  scrtop = document.body.scrollTop / 1250; // caching document.body.scrollTop / 1250
  // caching the Math.sin values into array - 5 values for each scrtop
  phasearray = [(Math.sin(scrtop+0)),(Math.sin(scrtop+1)),(Math.sin(scrtop+2)),(Math.sin(scrtop+3)),(Math.sin(scrtop+4))];
